...
a11y_statement: "https://bemmeker-ipoporto.min-saude.pt/accessibility-declaration?tab=android" # Entre as aspas escreve o URL da Declaração de Acessibilidade da App. A declaração da App está num URL público
...
<details>
  ...
  <ul aria-label="lista de relatórios já efetuados">
    <li><a href="17082026_report.html">(17/08/2026). Relatório App Android Bem-Me-Ker</a></li>
  </ul>
</details>
